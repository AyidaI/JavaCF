...
//1. Ask user to enter one string value with 3 words
    Scanner sc=new Scanner(System.in);
        System.out.println("Please enter the 3 Words");
    String words=sc.nextLine().trim();
    //2.  -Print first letter of Each Word
        String firstLetters="";
        // 3-Print last letter of each Word
        String lastLetters="";
        firstLetters+=words.charAt(0);
        //  4. print the total index of first letters
       ...
       // System.out.println(firstLetterIndex-lastLetterIndex);  --> not profetional
        int result=firstLetterIndex>lastLetterIndex ? firstLetterIndex-lastLetterIndex : lastLetterIndex-firstLetterIndex;
        //5. Print the sum of the last letter of each word's index number
